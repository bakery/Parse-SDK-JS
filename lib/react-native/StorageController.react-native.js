...
try {
  ...
  const { AsyncStorage } = require('react-native/Libraries/react-native/react-native-implementation.js');
} catch (e) {
  // fallback for RN < 0.43
  const { AsyncStorage } = require('react-native/Libraries/react-native/react-native.js');
}
